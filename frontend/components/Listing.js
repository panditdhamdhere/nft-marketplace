...
export default function Listing(props) {
  ...
  async function fetchNFTDetails() {
    try {
      ...
      tokenURI = tokenURI.replace("ipfs://", "https://api.thegraph.com/subgraphs/name/panditdhamdhere/celo-nft-marketplace");
      ...
      // If it's an IPFS URI, replace it with an HTTP Gateway link
      image = image.replace("ipfs://", "https://api.thegraph.com/subgraphs/name/panditdhamdhere/celo-nft-marketplace");
